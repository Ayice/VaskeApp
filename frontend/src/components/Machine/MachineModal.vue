<template>
  <div class="machine-modal">
    <div class="row">
      ...
      <div class="col-12">
        <form @submit.prevent="rentMachine" class="machine-modal__form">
          <select name="machineTime" class="custom-select mb-3" v-model="time">
            <option value selected disabled="true">Tid du skal bruge maskinen</option>
          ...
          <input type="submit" value="Brug maskine" class="btn btn-block btn-success" />
        </form>
      </div>
    </div>
  </div>
